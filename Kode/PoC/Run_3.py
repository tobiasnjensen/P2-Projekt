...
{
    "bssid": "string",      
    "anchor_id": "string",  #Identifikator for hvilken Raspberry Pi der har lavet målingen, f.eks. "anchor_3"
    "distance": float,  
}
    ...
    def packet_handler(packet) -> None:
        ...
        udp_sock.sendto( #Sender en JSON-pakke med måledata til serveren via UDP
            json.dumps({
                ...
                "anchor_id": "anchor_3"   #Identifikator for denne Raspberry Pi (hardcoded per Pi)
            }).encode('utf-8'),
